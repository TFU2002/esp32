    ...
    <div class="cards">
      <div class="card">
        ...
        <br>
          ...
          <p class="statusreadColor"><span>Pumper: </span><span id="status_read_DHT11_ESP32_1"><button onclick="pump()"><span id="pump_status">OFF</span></button></span></p>
...
void setup(){
  ...
  server.on("/humidity", handel_humidity);
  server.on("/moisure", handel_moisure);
